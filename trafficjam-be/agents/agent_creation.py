...
from utils.building_utils import extract_building_dict, distribute_agents_to_buildings
...
def prepare_building_dicts(buildings: List[Any]) -> List[Dict]:
    return [extract_building_dict(b) for b in buildings]
...
def create_single_agent(
    ...
    assign_amenity_preferences(agent, building_dicts)
...
def create_agents_from_network(
    ...
    assign_children_to_parents(agents, building_dicts)
